# Input do conjunto de dados histórico contendo vinte locações sorteadas aleatoriamente do banco de dados e armazenada em um data frame chamado dados:
...
# Explore a relação entre as variáveis Preço e Quadrimestre:
...
# Explore a relação entre as variáveis Preço e Portas:
...
# Explore a relação entre as variáveis Preço e Quilometragem:

plot(y = dados$Preco, x = dados$Quilometragem, pch = 16)
